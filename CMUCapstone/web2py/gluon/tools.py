...
class Mail(object):
    ...
    def __init__(self, server=None, sender=None, login=None, tls=True):
        ...
        Arguments:
            ...
            server: SMTP server addresses in addresses:port notation
            sender: sender email addresses
    ...
    def send(
        ...
        Arguments:
            ...
            reply_to: addresses to which reply should be composed
        ...
        Examples:
            ...
            #Send plain text message to single addresses:
            mail.send('you@example.com',
                      'Message subject',
                      'Plain text body of the message')

            #Send html message to single addresses:
            mail.send('you@example.com',
                      'Message subject',
        ...
        if not isinstance(self.settings.server, str):
            raise Exception('Server addresses not specified')
        if not isinstance(sender, str):
            raise Exception('Sender addresses not specified')
        ...
        if to:
            ...
            raise Exception('Target receiver addresses not specified')
        if cc:
...
def geocode(address):
    try:
        ...
        txt = fetch('http://maps.googleapis.com/maps/api/geocode/xml?sensor=false&addresses=%s'
                     % a)

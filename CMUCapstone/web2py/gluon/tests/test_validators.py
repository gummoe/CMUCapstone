...
class TestValidators(unittest.TestCase):
    ...
    def test_ANY_OF(self):
        ...
        self.assertEqual(rtn, ('@ab.co', 'enter a valid email addresses'))
    ...
    def test_IS_EMAIL(self):
        ...
        self.assertEqual(rtn, ('@def.com', 'enter a valid email addresses'))
        rtn =  IS_EMAIL()('"abc@def".com')      # quoted name
        self.assertEqual(rtn, ('"abc@def".com', 'enter a valid email addresses'))
        rtn =  IS_EMAIL()('abc+def.com')        # no @
        self.assertEqual(rtn, ('abc+def.com', 'enter a valid email addresses'))
        rtn =  IS_EMAIL()('abc@def.x')          # one-char TLD
        self.assertEqual(rtn, ('abc@def.x', 'enter a valid email addresses'))
        rtn =  IS_EMAIL()('abc@def.12')         # numeric TLD
        self.assertEqual(rtn, ('abc@def.12', 'enter a valid email addresses'))
        ...
        self.assertEqual(rtn, ('abc@def.c_m', 'enter a valid email addresses'))
        rtn =  IS_EMAIL()('NotAnEmail')         # missing @
        self.assertEqual(rtn, ('NotAnEmail', 'enter a valid email addresses'))
        rtn =  IS_EMAIL()('abc@NotAnEmail')     # missing TLD
        self.assertEqual(rtn, ('abc@NotAnEmail', 'enter a valid email addresses'))
        ...
        self.assertEqual(rtn, ('.wooly@example.com', 'enter a valid email addresses'))
        rtn =  IS_EMAIL()('wo..oly@example.com')      # adjacent dots in name
        self.assertEqual(rtn, ('wo..oly@example.com', 'enter a valid email addresses'))
        rtn =  IS_EMAIL()('pootietang.@example.com')  # dot ends name
        self.assertEqual(rtn, ('pootietang.@example.com', 'enter a valid email addresses'))
        rtn =  IS_EMAIL()('.@example.com')            # name is bare dot
        self.assertEqual(rtn, ('.@example.com', 'enter a valid email addresses'))
        ...
        self.assertEqual(rtn, ('Ima Fool@example.com', 'enter a valid email addresses'))
    ...
    def test_IS_EMPTY_OR(self):
        ...
        self.assertEqual(rtn, ('abc', 'enter a valid email addresses'))
        rtn =  IS_EMPTY_OR(IS_EMAIL())(' abc ')
        self.assertEqual(rtn, ('abc', 'enter a valid email addresses'))
    ...
    def test_IS_IPV4(self):
        ...
        rtn = IS_IPV4()('1.2.3.4 ')
        self.assertEqual(rtn, ('1.2.3.4 ', 'enter valid IPv4 addresses'))
        rtn = IS_IPV4()('1.2.3.4.5')
        self.assertEqual(rtn, ('1.2.3.4.5', 'enter valid IPv4 addresses'))
        rtn = IS_IPV4()('123.123')
        self.assertEqual(rtn, ('123.123', 'enter valid IPv4 addresses'))
        rtn = IS_IPV4()('1111.2.3.4')
        self.assertEqual(rtn, ('1111.2.3.4', 'enter valid IPv4 addresses'))
        rtn = IS_IPV4()('0111.2.3.4')
        self.assertEqual(rtn, ('0111.2.3.4', 'enter valid IPv4 addresses'))
        rtn = IS_IPV4()('256.2.3.4')
        self.assertEqual(rtn, ('256.2.3.4', 'enter valid IPv4 addresses'))
        rtn = IS_IPV4()('300.2.3.4')
        self.assertEqual(rtn, ('300.2.3.4', 'enter valid IPv4 addresses'))
        ...
        self.assertEqual(rtn, ('127.0.0.1', 'enter valid IPv4 addresses'))
    ...
    def test_IS_IPV6(self):
        ...
        self.assertEqual(rtn, ('192.168.1.1', 'enter valid IPv6 addresses'))
        ...
        self.assertEqual(rtn, ('fe80::126c:8ffa:fe22:b3af', 'enter valid IPv6 addresses'))
        rtn = IS_IPV6(is_link_local=True)('2001::126c:8ffa:fe22:b3af')
        self.assertEqual(rtn, ('2001::126c:8ffa:fe22:b3af', 'enter valid IPv6 addresses'))
        ...
        self.assertEqual(rtn, ('ff00::126c:8ffa:fe22:b3af', 'enter valid IPv6 addresses'))
        ...
        self.assertEqual(rtn, ('2001::8ffa:fe22:b3af', 'enter valid IPv6 addresses'))
    ...
    def test_IS_IPADDRESS(self):
        ...
        self.assertEqual(rtn, ('255.255.255.255', None))
        rtn = IS_IPADDRESS()('192.168.1.5 ')
        self.assertEqual(rtn, ('192.168.1.5 ', 'enter valid IP addresses'))
        rtn = IS_IPADDRESS()('192.168.1.1.5')
        self.assertEqual(rtn, ('192.168.1.1.5', 'enter valid IP addresses'))
        rtn = IS_IPADDRESS()('123.123')
        self.assertEqual(rtn, ('123.123', 'enter valid IP addresses'))
        rtn = IS_IPADDRESS()('1111.2.3.4')
        self.assertEqual(rtn, ('1111.2.3.4', 'enter valid IP addresses'))
        rtn = IS_IPADDRESS()('0111.2.3.4')
        self.assertEqual(rtn, ('0111.2.3.4', 'enter valid IP addresses'))
        rtn = IS_IPADDRESS()('256.2.3.4')
        self.assertEqual(rtn, ('256.2.3.4', 'enter valid IP addresses'))
        rtn = IS_IPADDRESS()('300.2.3.4')
        self.assertEqual(rtn, ('300.2.3.4', 'enter valid IP addresses'))
        ...
        self.assertEqual(rtn, ('192.168.1.4', 'enter valid IP addresses'))
        rtn = IS_IPADDRESS(is_localhost=True)('127.0.0.1')
        self.assertEqual(rtn, ('127.0.0.1', None))
        rtn = IS_IPADDRESS(is_localhost=True)('192.168.1.10')
        self.assertEqual(rtn, ('192.168.1.10', 'enter valid IP addresses'))
        rtn = IS_IPADDRESS(is_localhost=False)('127.0.0.1')
        self.assertEqual(rtn, ('127.0.0.1', 'enter valid IP addresses'))
        rtn = IS_IPADDRESS(maxip='100.0.0.0', is_localhost=True)('127.0.0.1')
        self.assertEqual(rtn, ('127.0.0.1', 'enter valid IP addresses'))
        rtn = IS_IPADDRESS()('aaa')
        self.assertEqual(rtn, ('aaa', 'enter valid IP addresses'))
        ...
        self.assertEqual(rtn, ('fe80::126c:8ffa:fe22:b3af', None))
        rtn = IS_IPADDRESS()('fe80::126c:8ffa:fe22:b3af  ')
        self.assertEqual(rtn, ('fe80::126c:8ffa:fe22:b3af  ', 'enter valid IP addresses'))
        rtn = IS_IPADDRESS(is_ipv4=True)('fe80::126c:8ffa:fe22:b3af')
        self.assertEqual(rtn, ('fe80::126c:8ffa:fe22:b3af', 'enter valid IP addresses'))
        rtn = IS_IPADDRESS(is_ipv6=True)('192.168.1.1')
        self.assertEqual(rtn, ('192.168.1.1', 'enter valid IP addresses'))
        ...
        self.assertEqual(rtn, ('2001::126c:8ffa:fe22:b3af', 'enter valid IP addresses'))
        ...
        self.assertEqual(rtn, ('ff00::126c:8ffa:fe22:b3af', 'enter valid IP addresses'))
        rtn = IS_IPADDRESS(subnets='2001::/32')('2001::8ffa:fe22:b3af')
        self.assertEqual(rtn, ('2001::8ffa:fe22:b3af', None))
        rtn = IS_IPADDRESS(subnets='fb00::/8')('2001::8ffa:fe22:b3af')
        self.assertEqual(rtn, ('2001::8ffa:fe22:b3af', 'enter valid IP addresses'))
